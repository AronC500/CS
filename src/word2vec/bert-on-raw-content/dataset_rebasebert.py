...
class ORGDataset(Dataset):
    ...
    @property
    def raw_dir(self):
        return os.path.join(self.root, 'raw_org2')
...
class ORGDataset_Normalized_After_BASEBERT(ORGDataset):
    ...
    def processed_dir(self):
        return os.path.join(self.root, 'raworg2_after_retrained_basebert')
    ...
    def process(self):
        ...
        model_path = "/home/user/PDFObj2Vec/obj2vec/raw_bert/final_bert_model"
        ...
        for raw_path in tqdm.tqdm(self.raw_file_names):
            ...
            try:
                ...
                if len(raw_path) >= len('1e04d7e1614400dcaf7c72f7b33b059f4e81a34c'):
                    y = 1
                else:
                    y = 0
...
def main():
    ...
    contagio_train_base = '/data/PDFObj2Vec/obj2vec/preprocess_data/contagio_train_base'
  
    contagio_label_path = '/home/user/PDFObj2Vec/dataset/contagio_train_base.csv'

 



    dataset = ORGDataset_Normalized_After_BASEBERT(root=contagio_train_base, label_path=contagio_label_path)
   
    

# print(f"File renamed from {source_file} to {target_file}")
