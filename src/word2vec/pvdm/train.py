...
class pvdm_model:
    def __init__(self, vec_dim=512, epochs=100, batch_size=4096, lr=5e-4, is_save=True,
                 ...
                 train_data_file = r"PDFObj2Vec/PVDM/dataset/unix24_train_data", 
                 test_data_file = r"PDFObj2Vec/PVDM/dataset/unix24_test_data", 
                 recorder_name=r"recorder_unix20_512.json", 
                 save_model_path = r"/home/dell/data/PDFObj2Vec/PVDM/record_v2/save_model_unix24_512"):
        ...
        # get all examples
        train_samples_save_file = r'/home/dell/data/PDFObj2Vec/PVDM/dataset/unix24_train_samples'
        test_samples_save_file = r'/home/dell/data/PDFObj2Vec/PVDM/dataset/unix24_test_samples'
